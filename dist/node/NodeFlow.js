...
var NodeSubsystem4 = class {
  ...
  clickEnd() {
    ...
    if (__privateGet(this, _portHovering).InputPort) {
      if (__privateGet(this, _portHovering).Port.getPortType() !== "INPUTARRAY" /* InputArray */) {
...
var FlowNode11 = class {
  constructor(config) {
    ...
    __privateSet(this, _titleColor, ((_d = (_c = config == null ? void 0 : config.style) == null ? void 0 : _c.title) == null ? void 0 : _d.color) === void 0 ? "#154050" : (_f = (_e = config == null ? void 0 : config.style) == null ? void 0 : _e.title) == null ? void 0 : _f.color);
    __privateSet(this, _padding, ((_h = (_g = config == null ? void 0 : config.style) == null ? void 0 : _g.title) == null ? void 0 : _h.padding) === void 0 ? 15 : (_j = (_i = config == null ? void 0 : config.style) == null ? void 0 : _i.title) == null ? void 0 : _j.padding);
    __privateSet(this, _stateStyles, /* @__PURE__ */ new Map());
    __privateGet(this, _stateStyles).set(0 /* Idle */, new BoxStyle(BoxStyleWithFallback((_k = config == null ? void 0 : config.style) == null ? void 0 : _k.idle, {
      border: { color: Theme.Node.Border.Idle, size: 1 },
      radius: Theme.Node.BorderRadius,
      color: Theme.Node.BackgroundColor
    })));
    __privateGet(this, _stateStyles).set(1 /* MouseOver */, new BoxStyle(BoxStyleWithFallback((_l = config == null ? void 0 : config.style) == null ? void 0 : _l.mouseOver, {
      border: { color: Theme.Node.Border.MouseOver, size: 1.1 },
      radius: Theme.Node.BorderRadius,
      color: Theme.Node.BackgroundColor
    })));
    __privateGet(this, _stateStyles).set(2 /* Grabbed */, new BoxStyle(BoxStyleWithFallback((_m = config == null ? void 0 : config.style) == null ? void 0 : _m.grabbed, {
      border: { color: Theme.Node.Border.Grabbed, size: 2 },
      radius: Theme.Node.BorderRadius,
      color: Theme.Node.BackgroundColor
    })));
    __privateSet(this, _selectedStyle, new BoxStyle(BoxStyleWithFallback((_n = config == null ? void 0 : config.style) == null ? void 0 : _n.selected, {
      border: { color: Theme.Node.Border.Selected, size: 1 },
      radius: Theme.Node.BorderRadius,
      color: Theme.Node.BackgroundColor
    })));
    __privateSet(this, _portTextStyle, new TextStyle({
      size: ((_p = (_o = config == null ? void 0 : config.style) == null ? void 0 : _o.portText) == null ? void 0 : _p.size) === void 0 ? 14 : (_r = (_q = config == null ? void 0 : config.style) == null ? void 0 : _q.portText) == null ? void 0 : _r.size,
      color: ((_t = (_s = config == null ? void 0 : config.style) == null ? void 0 : _s.portText) == null ? void 0 : _t.color) === void 0 ? Theme.Node.Port.FontColor : (_v = (_u = config == null ? void 0 : config.style) == null ? void 0 : _u.portText) == null ? void 0 : _v.color,
      font: (_x = (_w = config == null ? void 0 : config.style) == null ? void 0 : _w.portText) == null ? void 0 : _x.font,
      weight: (_z = (_y = config == null ? void 0 : config.style) == null ? void 0 : _y.portText) == null ? void 0 : _z.weight
    }));
