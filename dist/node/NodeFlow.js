...
// src/port.ts
var _displayName, _emptyStyle, _filledStyle, _connections, _type, _box;
;
...
// src/types/pool.ts
var _arr2, _count2, _builder, _reset;
var Pool = class {
  ...
  run(fn) {
    const start = __privateGet(this, _count2);
    fn();
    __privateSet(this, _count2, start);
  }
  get() {
    let value;
    if (__privateGet(this, _arr2).length === __privateGet(this, _count2)) {
      value = __privateGet(this, _builder).call(this);
      __privateGet(this, _arr2).push(__privateGet(this, _builder).call(this));
    } else {
      value = __privateGet(this, _arr2)[__privateGet(this, _count2)];
...
var NodeSubsystem4 = class {
  constructor(config) {
    ...
    __privateSet(this, _boxSelectStart_graphSpace, { x: 0, y: 0 });
    __privateSet(this, _boxSelectEnd_graphSpace, { x: 0, y: 0 });
  }
  addPublisher(identifier, publisher) {
  ...
  clickStart(mousePosition, camera, ctrlKey) {
    ...
    if (__privateGet(this, _portHovering) === null) {
      if (ctrlKey) {
        ...
        CopyVector22(__privateGet(this, _boxSelectEnd_graphSpace), __privateGet(this, _boxSelectStart_graphSpace));
  ...
  mouseDragEvent(delta, scale) {
    ...
    VectorPool.run(() => {
      ...
      AddVector22(__privateGet(this, _boxSelectEnd_graphSpace), __privateGet(this, _boxSelectEnd_graphSpace), scaledDelta);
  ...
  render(ctx, camera, mousePosition) {
    ...
    VectorPool.runIf(__privateGet(this, _boxSelect), () => {
      const start = VectorPool.get();
      const end = VectorPool.get();
      camera.graphSpaceToScreenSpace(__privateGet(this, _boxSelectStart_graphSpace), start);
      camera.graphSpaceToScreenSpace(__privateGet(this, _boxSelectEnd_graphSpace), end);
      const size = VectorPool.get();
      SubVector22(size, end, start);
      new BoxStyle({
        border: {
          color: "#00FF00",
          size: 2
...
renderNodes_fn = function(ctx, camera, mousePosition) {
  ...
  for (let i = 0; i < __privateGet(this, _nodes).length; i++) {
    let state = 0 /* Idle */;
    if (mousePosition !== void 0) {
      const intersection = __privateGet(this, _nodes)[i].inBounds(ctx, camera.position, camera.zoom, mousePosition);
    ...
    __privateGet(this, _nodes)[i].render(ctx, camera.position, camera.zoom, state, mousePosition);
  }
};
...
var FlowNode10 = class {
  ...
  render(ctx, graphPosition, scale, state, mousePosition) {
    VectorPool.run(() => {
      ...
      __privateGet(this, _title2).render(ctx, scale, titlePosition);
...
var FlowNote = class {
  ...
  render(ctx, camera, mousePosition) {
    ...
    const startY = __privateGet(this, _position2).y * camera.zoom + camera.position.y;
    __privateGet(this, _tempPosition).x = __privateGet(this, _position2).x * camera.zoom + camera.position.x;
    ...
    __privateGet(this, _lastRenderedBox).Size.x = camera.zoom * __privateGet(this, _width) + boundsSpacing * 2;
...
var NodeFlowGraph2 = class {
  constructor(canvas, config) {
    ...
    __privateSet(this, _camera, new Camera4());
...
fileDrop_fn = function(file) {
  ...
  let pos = { x: 0, y: 0 };
  if (__privateGet(this, _mousePosition2)) {
    CopyVector22(pos, __privateMethod(this, _sceenPositionToGraphPosition, sceenPositionToGraphPosition_fn).call(this, __privateGet(this, _mousePosition2)));
  }
