...
var List = class {
  ...
  At(index) {
    return __privateGet(this, _arr)[index];
  }
  Push(value) {
    if (__privateGet(this, _arr).length === __privateGet(this, _count)) {
      __privateGet(this, _arr).push(value);
    } else {
      __privateGet(this, _arr)[__privateGet(this, _count)] = value;
    }
    __privateWrapper(this, _count)._++;
  }
  ToArray() {
    let arr = new Array(this.Count());
    for (let i = 0; i < __privateGet(this, _count); i++) {
      arr[i] = __privateGet(this, _arr)[i];
    }
    return arr;
  }
};
...
var _ContextMenu = class {
  constructor(config) {
    ...
    __privateAdd(this, _tempBox, { Position: { x: 0, y: 0 }, Size: { x: 0, y: 0 } });
...
getMaxWidthForText_fn = function(ctx, scale) {
  ...
  for (let groupIndex = 0; groupIndex < __privateGet(this, _groups).Count(); groupIndex++) {
    const group = __privateGet(this, _groups).At(groupIndex);
    for (let entryIndex = 0; entryIndex < group.entries.length; entryIndex++) {
      const vec = __privateGet(this, _textStyle2).measure(ctx, scale, group.entries[entryIndex].text);
      __privateSet(this, _calculatedWidth, Math.max(vec.x, __privateGet(this, _calculatedWidth)));
    }
  }
  return __privateGet(this, _calculatedWidth);
};
...
function CopyVector22(dst, src) {
  dst.x = src.x;
  dst.y = src.y;
}
function SubVector22(dst, a, b) {
  dst.x = a.x - b.x;
  dst.y = a.y - b.y;
}
function AddVector22(dst, a, b) {
  dst.x = a.x + b.x;
  dst.y = a.y + b.y;
}

// src/input.ts
var _clicked, _lastTouch, _ele, _dragCallback, _moveCallback, _clickStart, _clickStop, _contextMenu, _mousePosition, mousePosition_fn, _move, move_fn, _moveTouch, moveTouch_fn, _down, down_fn, _touchDown, touchDown_fn, _up, up_fn;
...
move_fn = function(event) {
  ...
  __privateGet(this, _moveCallback).call(this, __privateMethod(this, _mousePosition, mousePosition_fn).call(this, event));
};
...
moveTouch_fn = function(event) {
  ...
  CopyVector22(__privateGet(this, _lastTouch), pos);
};
_down = new WeakSet();
...
// src/port.ts
var _displayName, _emptyStyle, _filledStyle, _connections, _type;
;
...
var Port = class {
  constructor(config) {
    ...
    __privateSet(this, _type, (config == null ? void 0 : config.type) === void 0 ? "" : config == null ? void 0 : config.type);
    __privateSet(this, _emptyStyle, {
      ...
      fillColor: ((_c = config == null ? void 0 : config.emptyStyle) == null ? void 0 : _c.fillColor) === void 0 ? fallbackColor(__privateGet(this, _type), 0.3) : (_d = config.emptyStyle) == null ? void 0 : _d.fillColor,
    ...
    __privateSet(this, _filledStyle, {
      ...
      fillColor: ((_k = config == null ? void 0 : config.filledStyle) == null ? void 0 : _k.fillColor) === void 0 ? fallbackColor(__privateGet(this, _type), 1) : (_l = config.filledStyle) == null ? void 0 : _l.fillColor,
...
// src/styles/box.ts
var _border, _color3, _radius, _box, box_fn, _draw, draw_fn;
...
var BoxStyle = class {
  ...
  DrawUnderline(ctx, box, scale) {
    __privateMethod(this, _box, box_fn).call(this, ctx, box, scale, [__privateGet(this, _radius) * scale * 2, __privateGet(this, _radius) * scale * 2, 0, 0]);
    ctx.beginPath();
...
draw_fn = function(ctx, box, scale, radius) {
  __privateMethod(this, _box, box_fn).call(this, ctx, box, scale, radius);
  ctx.stroke();
};
...
var _Text = class {
  constructor(value, style) {
    ...
    __privateSet(this, _size3, { x: 0, y: 0 });
  ...
  size(ctx, scale, out) {
    ...
    CopyVector22(out, __privateGet(this, _size3));
    out.x *= scale;
    out.y *= scale;
  }
  setColor(color) {
...
var _box2, _text, _textAlign, _textBaseline;
...
var TextBoxStyle = class {
  constructor(config) {
    ...
    __privateSet(this, _box2, new BoxStyle(config == null ? void 0 : config.box));
  ...
  Draw(ctx, box, scale, text) {
    __privateGet(this, _box2).Draw(ctx, box, scale);
  ...
  DrawUnderline(ctx, box, scale, text) {
    __privateGet(this, _box2).DrawUnderline(ctx, box, scale);
    ctx.textAlign = __privateGet(this, _textAlign);
    ctx.textBaseline = __privateGet(this, _textBaseline);
    __privateGet(this, _text).setupStyle(ctx, scale);
    ctx.fillText(
  ...
  setBoxColor(color) {
    __privateGet(this, _box2).setColor(color);
  }
  setBorderColor(color) {
    __privateGet(this, _box2).setBorderColor(color);
  }
};
_box2 = new WeakMap();
_text = new WeakMap();
...
var _node, _nodeProperty, _value2, _idleBoxStyle, _highlightBoxStyle, _text2, _callback2;
var NumberWidget = class {
  constructor(node, config) {
    ...
    if (__privateGet(this, _nodeProperty) !== void 0) {
      __privateGet(this, _node).subscribeToProperty(__privateGet(this, _nodeProperty), (oldVal, newVal) => {
        this.Set(newVal);
      });
    }
  }
  ...
  Set(newNumber) {
    ...
    if (__privateGet(this, _nodeProperty) !== void 0) {
      __privateGet(this, _node).setProperty(__privateGet(this, _nodeProperty), __privateGet(this, _value2));
    }
...
var _node2, _nodeProperty2, _value3, _contrast, _textBoxStyle, _callback4;
...
var ColorWidget = class {
  constructor(node, config) {
    ...
    if (__privateGet(this, _nodeProperty2) !== void 0) {
      __privateGet(this, _node2).subscribeToProperty(__privateGet(this, _nodeProperty2), (oldVal, newVal) => {
        this.Set(newVal);
      });
    }
  }
  ...
  Set(value) {
    ...
    if (__privateGet(this, _nodeProperty2) !== void 0) {
      __privateGet(this, _node2).setProperty(__privateGet(this, _nodeProperty2), __privateGet(this, _value3));
    }
...
var _min, _max, _value4, _text4, _snapIncrement, _node3, _nodeProperty3, _change, _release, _textStyle3, _backgroundColor, _borderColor, _fillColor, _lastMousePosition, _clickStartMousePosition, _clicking;
var SliderWidget = class {
  constructor(node, config) {
    ...
    __privateSet(this, _lastMousePosition, { x: 0, y: 0 });
    __privateSet(this, _clickStartMousePosition, { x: 0, y: 0 });
  ...
  SetValue(newValue) {
    ...
    if (__privateGet(this, _nodeProperty3)) {
      __privateGet(this, _node3).setProperty(__privateGet(this, _nodeProperty3), __privateGet(this, _value4));
    }
  ...
  ClickStart() {
    ...
    CopyVector22(__privateGet(this, _clickStartMousePosition), __privateGet(this, _lastMousePosition));
  }
  ClickEnd() {
    __privateSet(this, _clicking, false);
  ...
  Draw(ctx, position, scale, mousePosition) {
    ...
    if (mousePosition !== void 0) {
      CopyVector22(__privateGet(this, _lastMousePosition), mousePosition);
      if (__privateGet(this, _clicking)) {
        ...
        const p = Clamp01((__privateGet(this, _lastMousePosition).x - min) / (max - min));
...
var _value5, _idleStyle2, _hoverStyle2, _callback5, _node4, _nodeProperty4;
var StringWidget = class {
  constructor(node, config) {
    ...
    if (__privateGet(this, _nodeProperty4) !== void 0) {
      __privateGet(this, _node4).subscribeToProperty(__privateGet(this, _nodeProperty4), (oldVal, newVal) => {
        this.Set(newVal);
      });
    }
  }
  ...
  Set(value) {
    ...
    if (__privateGet(this, _nodeProperty4) !== void 0) {
      __privateGet(this, _node4).setProperty(__privateGet(this, _nodeProperty4), __privateGet(this, _value5));
    }
...
var _idleStyle3, _hoverStyle3, _lightColor, _lightBorderColor, _lightBlur, _node5, _nodeProperty5, _value6, _text5, _enabledStyle, _disabledStyle, _callback6;
...
var ToggleWidget = class {
  constructor(node, config) {
    ...
    if (__privateGet(this, _nodeProperty5) !== void 0) {
      __privateGet(this, _node5).subscribeToProperty(__privateGet(this, _nodeProperty5), (oldVal, newVal) => {
        this.Set(newVal);
      });
    }
  }
  ...
  Set(value) {
    ...
    if (__privateGet(this, _nodeProperty5) !== void 0) {
      __privateGet(this, _node5).setProperty(__privateGet(this, _nodeProperty5), __privateGet(this, _value6));
    }
...
// src/widgets/text.ts
var _value7, _callback7, _node6, _nodeProperty6, _size4;
var TextWidget = class {
  constructor(node, config) {
    ...
    __privateSet(this, _size4, { x: 0, y: 0 });
    ...
    if (__privateGet(this, _nodeProperty6) !== void 0) {
      __privateGet(this, _node6).subscribeToProperty(__privateGet(this, _nodeProperty6), (oldVal, newVal) => {
        this.Set(newVal);
      });
    }
  }
  ...
  Set(value) {
    ...
    if (__privateGet(this, _nodeProperty6) !== void 0) {
      __privateGet(this, _node6).setProperty(__privateGet(this, _nodeProperty6), value);
    }
...
var Connection2 = class {
  constructor(inNode, inNodePortIndex, outNode, outNodePortIndex, renderer) {
    ...
    __privateSet(this, _inPos, { x: 0, y: 0 });
    __privateSet(this, _outPos, { x: 0, y: 0 });
    if (inNode !== null) {
  ...
  for (let [key, nodeConfig] of subMenu) {
    ...
    if (elements.length === 1) {
      items.push({
        name: key,
        callback: () => {
          const node = new FlowNode10(nodeConfig);
...
var NodeSubsystem4 = class {
  ...
  clickStart(mousePosition, ctrlKey) {
  ...
  mouseDragEvent(delta, scale) {
    ...
    return __privateMethod(this, _interactingWithConnection, interactingWithConnection_fn).call(this) || __privateMethod(this, _interactingWithWidget, interactingWithWidget_fn).call(this);
  }
  ...
  render(ctx, scale, position, mousePosition) {
    __privateSet(this, _cursor, "default" /* Default */);
    TimeExecution("Render_Connections", () => {
      __privateMethod(this, _renderConnections, renderConnections_fn).call(this, ctx, scale, position, mousePosition);
    });
    TimeExecution("Render_Nodes", () => {
      __privateMethod(this, _renderNodes, renderNodes_fn).call(this, ctx, scale, position, mousePosition);
    });
    return {
      cursorStyle: __privateGet(this, _cursor)
    };
  }
};
_nodes = new WeakMap();
...
renderConnections_fn = function(ctx, scale, position, mousePosition) {
  for (let i = 0; i < __privateGet(this, _connections2).length; i++) {
    let portMousedOver = false;
    if (mousePosition !== void 0) {
      portMousedOver = __privateGet(this, _connections2)[i].mouseOverPort(mousePosition) !== null;
    }
    __privateGet(this, _connections2)[i].render(ctx, scale, portMousedOver, mousePosition);
  }
};
_renderNodes = new WeakSet();
renderNodes_fn = function(ctx, scale, position, mousePosition) {
  __privateSet(this, _portHovering, null);
  __privateSet(this, _widgetHovering, null);
  __privateSet(this, _nodeHovering, -1);
  for (let i = 0; i < __privateGet(this, _nodes).length; i++) {
    let state = 0 /* Idle */;
    if (mousePosition !== void 0) {
      const intersection = __privateGet(this, _nodes)[i].inBounds(ctx, position, scale, mousePosition);
    ...
    __privateGet(this, _nodes)[i].render(ctx, position, scale, state, mousePosition);
  }
};
...
var FlowNode10 = class {
  ...
  setPosition(position) {
    CopyVector22(__privateGet(this, _position), position);
  }
  calculateBounds(ctx, graphPosition, scale) {
    const scaledPadding = __privateGet(this, _padding);
    const position = {
      x: __privateGet(this, _position).x * scale + graphPosition.x,
      y: __privateGet(this, _position).y * scale + graphPosition.y
    };
    const scaledTitleMeasurement = { x: 0, y: 0 };
    __privateGet(this, _title2).size(ctx, 1, scaledTitleMeasurement);
    const size = {
      x: scaledTitleMeasurement.x + scaledPadding * 2,
      y: scaledTitleMeasurement.y + scaledPadding * 2
    };
    size.y += __privateGet(this, _elementSpacing) * __privateGet(this, _input).length;
    for (let i = 0; i < __privateGet(this, _input).length; i++) {
      const port = __privateGet(this, _input)[i];
      const measurement = __privateGet(this, _portTextStyle).measure(ctx, 1, port.getDisplayName());
  ...
  addInput(port) {
    __privateGet(this, _input).push(new Port(port));
  }
  addOutput(port) {
    __privateGet(this, _output).push(new Port(port));
  }
  addWidget(widget) {
  ...
  inBounds(ctx, graphPosition, scale, position) {
    var intersection = {};
  ...
  render(ctx, graphPosition, scale, state, mousePosition) {
    ...
    const scaledPadding = __privateGet(this, _padding) * scale;
    const scaledElementSpacing = __privateGet(this, _elementSpacing) * scale;
    ...
    __privateGet(this, _title2).size(ctx, scale, titleSize);
    const titleBox = {
    ...
    ctx.fill();
    __privateGet(this, _title2).render(ctx, scale, {
    ...
    for (let i = 0; i < __privateGet(this, _input).length; i++) {
      const port = __privateGet(this, _input)[i];
      const measurement = __privateGet(this, _portTextStyle).measure(ctx, scale, port.getDisplayName());
      const position = { x: nodeBounds.Position.x, y: startY + measurement.y / 2 };
      __privateGet(this, _portTextStyle).setupStyle(ctx, scale);
      ctx.fillText(port.getDisplayName(), leftSide, position.y);
      __privateGet(this, _inputPortPositions).Push(port.render(ctx, position, scale));
    ...
    for (let i = 0; i < __privateGet(this, _output).length; i++) {
      ...
      __privateGet(this, _outputPortPositions).Push(port.render(ctx, position, scale));
      startY += measurement.y + scaledElementSpacing;
    }
    for (let i = 0; i < __privateGet(this, _widgets).length; i++) {
      ...
      __privateGet(this, _widgetPositions).Push(widget.Draw(ctx, position, scale, mousePosition));
...
var _type2, _lexeme, _tokenStart, _tokenEnd;
...
var FlowNote = class {
  constructor(config) {
    ...
    __privateAdd(this, _tempPosition, { x: 0, y: 0 });
  ...
  render(ctx, graphPosition, scale, mousePosition) {
    if (__privateGet(this, _edittingLayout) && (__privateGet(this, _hovering) || __privateGet(this, _handleSelected) !== 0 /* None */)) {
      if (mousePosition) {
        if (__privateGet(this, _handleSelected) === 2 /* Right */) {
          const leftPosition = __privateGet(this, _position2).x * scale + graphPosition.x;
          __privateSet(this, _width, Math.max((mousePosition.x - leftPosition) / scale, 1));
        } else if (__privateGet(this, _handleSelected) === 1 /* Left */) {
          const scaledWidth = __privateGet(this, _width) * scale;
          const rightPosition = __privateGet(this, _position2).x * scale + graphPosition.x + scaledWidth;
          __privateSet(this, _width, Math.max((rightPosition - mousePosition.x) / scale, 1));
          __privateGet(this, _position2).x = rightPosition - __privateGet(this, _width) * scale - graphPosition.x;
          __privateGet(this, _position2).x /= scale;
        }
      }
      __privateGet(this, _edittingStyle).Outline(ctx, this.leftResizeHandleBox(), scale, 2);
      __privateGet(this, _edittingStyle).Outline(ctx, this.rightResizeHandleBox(), scale, 2);
      ctx.beginPath();
      ...
      ctx.moveTo(left, bottom + __privateGet(this, _lastRenderedBox).Size.y / 2 - boxSize);
      ctx.lineTo(left, bottom);
      ctx.lineTo(right, bottom);
      ctx.lineTo(right, bottom + __privateGet(this, _lastRenderedBox).Size.y / 2 - boxSize);
      ctx.moveTo(left, top - __privateGet(this, _lastRenderedBox).Size.y / 2 + boxSize);
      ctx.lineTo(left, top);
      ctx.lineTo(right, top);
      ctx.lineTo(right, top - __privateGet(this, _lastRenderedBox).Size.y / 2 + boxSize);
      ctx.stroke();
    }
    const startY = __privateGet(this, _position2).y * scale + graphPosition.y;
    __privateGet(this, _tempPosition).x = __privateGet(this, _position2).x * scale + graphPosition.x;
    __privateGet(this, _tempPosition).y = startY;
    CopyVector22(__privateGet(this, _lastRenderedBox).Position, __privateGet(this, _tempPosition));
    ...
    for (let i = 0; i < __privateGet(this, _document).length; i++) {
      ...
      __privateGet(this, _tempPosition).y += text.render(ctx, __privateGet(this, _tempPosition), scale, __privateGet(this, _width)) + lineSpacing;
    }
    __privateGet(this, _lastRenderedBox).Position.x -= boundsSpacing;
    __privateGet(this, _lastRenderedBox).Position.y -= boundsSpacing;
    __privateGet(this, _lastRenderedBox).Size.x = scale * __privateGet(this, _width) + boundsSpacing * 2;
    __privateGet(this, _lastRenderedBox).Size.y = __privateGet(this, _tempPosition).y - startY + boundsSpacing * 2;
  }
  leftResizeHandleBox() {
    return {
      Position: {
        x: __privateGet(this, _lastRenderedBox).Position.x - boxSize / 2,
        y: __privateGet(this, _lastRenderedBox).Position.y + __privateGet(this, _lastRenderedBox).Size.y / 2 - boxSize / 2
      },
  ...
  rightResizeHandleBox() {
    return {
      Position: {
        x: __privateGet(this, _lastRenderedBox).Position.x - boxSize / 2 + __privateGet(this, _lastRenderedBox).Size.x,
        y: __privateGet(this, _lastRenderedBox).Position.y + __privateGet(this, _lastRenderedBox).Size.y / 2 - boxSize / 2
      },
      Size: { x: boxSize, y: boxSize }
    };
...
var NoteSubsystem = class {
  ...
  render(ctx, scale, position, mousePosition) {
    ...
    for (let i = 0; i < __privateGet(this, _notes).length; i++) {
      __privateGet(this, _notes)[i].render(ctx, position, scale, mousePosition);
    }
    return;
  }
};
...
// src/graph.ts
var _subsystems, _ctx, _canvas, _backgroundRenderer, _contextMenuConfig, _position3, _mousePosition2, _scale, _openedContextMenu, _contextMenuEntryHovering, _views, _currentView, _mainNodeSubsystem, _mainNoteSubsystem, _fileDrop, fileDrop_fn, _clickStart2, clickStart_fn, _sceenPositionToMousePosition, sceenPositionToMousePosition_fn, _openContextMenu, openContextMenu_fn, _resetView, resetView_fn, _clickEnd, clickEnd_fn, _mouseDragEvent, mouseDragEvent_fn, _lastFrameCursor, _cursor2, _render, render_fn, _renderBackground, renderBackground_fn, _renderContextMenu, renderContextMenu_fn;
...
var GraphView = class {
  ...
  clickStart(mousePosition, ctrlKey) {
    for (let i = __privateGet(this, _subsystems).length - 1; i >= 0; i--) {
      if (__privateGet(this, _subsystems)[i].clickStart(mousePosition, ctrlKey)) {
        return;
      }
    }
  }
  ...
  render(ctx, scale, position, mousePosition) {
    ...
    for (let i = 0; i < __privateGet(this, _subsystems).length; i++) {
      TimeExecution("Render_Subsystem_" + i, () => {
        let results2 = __privateGet(this, _subsystems)[i].render(ctx, scale, position, mousePosition);
...
var NodeFlowGraph2 = class {
  constructor(canvas, config) {
    ...
    __privateAdd(this, _sceenPositionToMousePosition);
    __privateAdd(this, _openContextMenu);
    __privateAdd(this, _resetView);
    ...
    __privateAdd(this, _scale, void 0);
    ...
    __privateSet(this, _scale, 1);
    __privateSet(this, _position3, { x: 0, y: 0 });
    __privateSet(this, _contextMenuConfig, CombineContextMenus({
      items: [
        {
          name: "Reset View",
          group: contextMenuGroup,
          callback: __privateMethod(this, _resetView, resetView_fn).bind(this)
        }
      ]
  ...
  zoom(amount) {
    ...
    if (__privateGet(this, _mousePosition2)) {
      oldPos = __privateMethod(this, _sceenPositionToMousePosition, sceenPositionToMousePosition_fn).call(this, __privateGet(this, _mousePosition2));
      ;
    }
    __privateSet(this, _scale, __privateGet(this, _scale) + amount * __privateGet(this, _scale) * 0.05);
    if (!oldPos || !__privateGet(this, _mousePosition2)) {
      return;
    }
    const newPos = __privateMethod(this, _sceenPositionToMousePosition, sceenPositionToMousePosition_fn).call(this, __privateGet(this, _mousePosition2));
    __privateGet(this, _position3).x += (newPos.x - oldPos.x) * __privateGet(this, _scale);
    __privateGet(this, _position3).y += (newPos.y - oldPos.y) * __privateGet(this, _scale);
  }
  currentView() {
...
fileDrop_fn = function(file) {
  ...
  let pos = { x: 0, y: 0 };
  if (__privateGet(this, _mousePosition2)) {
    CopyVector22(pos, __privateMethod(this, _sceenPositionToMousePosition, sceenPositionToMousePosition_fn).call(this, __privateGet(this, _mousePosition2)));
  }
  __privateGet(this, _mainNodeSubsystem).addNode(new FlowNode10({
    title: contents[0],
    position: pos,
    widgets: [{
      type: "image",
...
_sceenPositionToMousePosition = new WeakSet();
sceenPositionToMousePosition_fn = function(screenPosition) {
  return {
    x: screenPosition.x / __privateGet(this, _scale) - __privateGet(this, _position3).x / __privateGet(this, _scale),
    y: screenPosition.y / __privateGet(this, _scale) - __privateGet(this, _position3).y / __privateGet(this, _scale)
  };
};
_openContextMenu = new WeakSet();
openContextMenu_fn = function(position) {
  let finalConfig = __privateGet(this, _contextMenuConfig);
  const contextMenuPosition = __privateMethod(this, _sceenPositionToMousePosition, sceenPositionToMousePosition_fn).call(this, position);
...
_resetView = new WeakSet();
resetView_fn = function() {
  __privateSet(this, _scale, 1);
  __privateGet(this, _position3).x = 0;
  __privateGet(this, _position3).y = 0;
};
...
mouseDragEvent_fn = function(delta) {
  let draggingSomething = this.currentView().mouseDragEvent(delta, __privateGet(this, _scale));
  if (!draggingSomething) {
    __privateGet(this, _position3).x += delta.x;
    __privateGet(this, _position3).y += delta.y;
  }
};
...
render_fn = function() {
  ...
  TimeExecution("Render_View_" + __privateGet(this, _currentView), () => {
    let results = this.currentView().render(__privateGet(this, _ctx), __privateGet(this, _scale), __privateGet(this, _position3), __privateGet(this, _mousePosition2));
...
renderBackground_fn = function() {
  __privateGet(this, _backgroundRenderer).call(this, __privateGet(this, _canvas), __privateGet(this, _ctx), __privateGet(this, _position3), __privateGet(this, _scale));
};
_renderContextMenu = new WeakSet();
renderContextMenu_fn = function() {
  if (__privateGet(this, _openedContextMenu) !== null) {
    __privateSet(this, _contextMenuEntryHovering, __privateGet(this, _openedContextMenu).Menu.render(__privateGet(this, _ctx), {
      x: __privateGet(this, _position3).x + __privateGet(this, _openedContextMenu).Position.x * __privateGet(this, _scale),
      y: __privateGet(this, _position3).y + __privateGet(this, _openedContextMenu).Position.y * __privateGet(this, _scale)
    }, __privateGet(this, _scale), __privateGet(this, _mousePosition2)));
    if (__privateGet(this, _contextMenuEntryHovering) !== null) {
...
globalThis.FlowNode = FlowNode10;
